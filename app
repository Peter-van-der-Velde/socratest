...
function test {
    ...
    export DISPLAY=:0
    ./com.gitlab.Peter_van_der_Velde.socratest --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.gitlab.Peter_van_der_Velde.socratest-pot
    ninja com.gitlab.Peter_van_der_Velde.socratest-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.gitlab.Peter_van_der_Velde.socratest "${@:2}"
    ;;
"test")
    test
    ;;
